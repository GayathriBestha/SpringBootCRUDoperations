...
public class User {
	...
	public String toString() {
		return "User [user_Id=" + user_Id + ", user_Name=" + user_Name + ", user_Email=" + user_Email + ", user_Gen="
				+ user_Gen + ", user_Phone=" + user_Phone + ", user_City=" + user_City + ", user_Pincode="
				+ user_Pincode + "]";
	}
	public User() {
		super();
